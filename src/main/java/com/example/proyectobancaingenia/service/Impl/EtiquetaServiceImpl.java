...
import com.example.proyectobancaingenia.dao.impl.ExpertoDAOImpl;
import com.example.proyectobancaingenia.model.Etiqueta;
import com.example.proyectobancaingenia.model.Experto;
import com.example.proyectobancaingenia.repository.EtiquetaRepository;
...
public class EtiquetaServiceImpl implements EtiquetaService {
    ...
    public Etiqueta crearEtiqueta(Etiqueta etiqueta) {
        if(etiqueta.getId() == 0){
            ...
            etiqueta.setCreatedAt(LocalDate.now());
            etiqueta.setUpdatedAt(LocalDate.now());
